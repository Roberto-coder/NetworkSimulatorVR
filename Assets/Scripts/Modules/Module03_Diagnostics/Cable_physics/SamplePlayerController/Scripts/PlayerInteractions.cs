...
namespace Modules.Module03_Diagnostics.Cable_physics.SamplePlayerController.Scripts
{
    public class PlayerInteractions : MonoBehaviour, IObjectHolder
    {
        ...
        private void OnEnable()
        {
            ...
            Modules.Module03_Diagnostics.Cable_physics.SamplePlayerController.Scripts.PlayerController.OnPlayerEnterPortal += CheckHeldObjectOnTeleport;
        }
