...
namespace Modules.Module02_RackInstallation.Presentation
{
    ...
    public sealed class InfoCardController : MonoBehaviour
    {
        ...
        public RackInfoTarget DisplayedTarget => displayedTarget;
        public event System.Action<RackInfoTarget, int> PageShown;
        ...
        private void ChangePage(int delta)
        {
            ...
            PageShown?.Invoke(displayedTarget, page);
